...
.NOTES
    ...
    Version    : 1.0.0 (WPF shell, replaces v1.1.0 WinForms)
    Updated    : 2026-04-23
#>
...
<Controls:MetroWindow
    ...
    <Grid Margin="20,18,20,14">
        ...
        <TextBlock x:Name="txtIcon" Grid.Row="0" Grid.Column="0" FontFamily="Segoe UI Symbol" FontSize="20" VerticalAlignment="Top" Margin="0,0,14,0"/>
